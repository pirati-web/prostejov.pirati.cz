...
<div class="mt-4 md:mt-8 space-y-4">
  {% include buttons/icon.html icon="ico--chevron-right" href="/volby-2020/kodex-zastupitele-2022.pdf" cta="Volební noviny" class="btn--blue-300 btn--hoveractive btn--fullwidth md:btn--autowidth text-lg" %}
